...
python /home/sebastiano/voxel-serl/examples/box_picking_drq/drq_policy_hil.py "$@" \
    ...
    --batch_size 128 \
    --max_traj_length 100 \
    --checkpoint_path "/home/sebastiano/voxel-serl/examples/box_picking_drq/experiment_setup/VoxNet_pretrained/checkpoints dual lift voxnet pretrained 0131-16:10"\
    --eval_checkpoint_step 500 \
    --eval_n_trajs 10 \
    \
    --dual \
