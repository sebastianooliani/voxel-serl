...
class DualObservationStatisticsWrapper(gym.Wrapper, gym.utils.RecordConstructorArgs):
    """
    This wrapper will keep track of the observation statistics. It is designed for dual arm environments.
