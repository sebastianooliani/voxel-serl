...
class PointCloudFusion:
    ...
    def load_finetuned(self):
        ...
        if not exists("/home/sebastiano/voxel-serl/examples/box_picking_drq/PointCloudFusionFinetuned.npy"):
            return False
        with open("/home/sebastiano/voxel-serl/examples/box_picking_drq/PointCloudFusionFinetuned.npy", "rb") as f:
