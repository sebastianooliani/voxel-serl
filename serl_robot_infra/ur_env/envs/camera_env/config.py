...
class UR5CameraConfigDualRobot(DualRobotDefaultEnvConfig):
    ...
    TOP = True
    HER = True
    TASK = "inairrot" # "lift", "reorient", "motion", "inairrot"
    ...
    RESET_Q = {
        ...
        "motion": np.array([[- math.pi / 6., math.radians(-88.27), math.radians(119.11), math.radians(-120.27), math.radians(-89.92), math.radians(0.),
                         math.radians(147.55), math.radians(-92.65), math.radians(119.91), math.radians(-116.80), math.radians(-90.02), math.radians(0.)]]),
        "inairrot": np.array([[- math.pi / 6., math.radians(-88.27), math.radians(119.11), math.radians(-120.27), math.radians(-89.92), math.radians(0.),
                         math.radians(147.55), math.radians(-92.65), math.radians(119.91), math.radians(-116.80), math.radians(-90.02), math.radians(0.)]])
    }

    # box in vertical position
    # RESET_Q = {
    #     "lift": np.array([[math.radians(-48.84), math.radians(-53.56), math.radians(99.53), math.radians(-51.25), math.radians(-50.28), math.radians(1.62),
    #                      math.radians(148.59), math.radians(-54.08), math.radians(110.62), math.radians(-59.62), math.radians(-31.03), math.radians(32.72)]]),
    #     "reorient": np.array([[math.radians(-48.84), math.radians(-53.56), math.radians(99.53), math.radians(-51.25), math.radians(-50.28), math.radians(1.62),
    #                      math.radians(148.59), math.radians(-54.08), math.radians(110.62), math.radians(-59.62), math.radians(-31.03), math.radians(32.72)]]),
    #     "motion": np.array([[math.radians(-48.84), math.radians(-53.56), math.radians(99.53), math.radians(-51.25), math.radians(-50.28), math.radians(1.62),
    #                      math.radians(148.59), math.radians(-54.08), math.radians(110.62), math.radians(-59.62), math.radians(-31.03), math.radians(32.72)]])
    # }
    # mid reset position
    ...
    ABS_POSE_LIMIT_LOW_ROBOT_1 = {
        ...
        "inairrot": np.array([-0.605, -0.110, 0.110, -0.2, -0.2, -0.2]),
    }
    ...
    ABS_POSE_LIMIT_LOW_ROBOT_2 = {
        ...
        "inairrot": np.array([0.301, -0.235, 0.128, -0.2, -0.2, -0.2]),
    }
